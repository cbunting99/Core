...
{
    public:
        Spectator_Commands() : CommandScript("Spectator_Commands") { }
...
{
    public:
        Spectator_NPC() : CreatureScript("Spectator_NPC") { }

        bool OnGossipHello(Player* pPlayer, Creature* pCreature)
        {
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Games: +2100.", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_LIST_TOP_GAMES);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Games: +1000.", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_LIST_GAMES);
