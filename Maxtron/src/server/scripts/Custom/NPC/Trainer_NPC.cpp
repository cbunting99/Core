uint32 WARRIOR_GLYPH_VENDOR      = 26332;
uint32 PALADIN_GLYPH_VENDOR      = 26327;
uint32 HUNTER_GLYPH_VENDOR       = 26325;
uint32 ROGUE_GLYPH_VENDOR        = 26329;
uint32 PRIEST_GLYPH_VENDOR       = 26328;
uint32 DEATH_KNIGHT_GLYPH_VENDOR = 33251;
uint32 SHAMAN_GLYPH_VENDOR       = 26330;
uint32 MAGE_GLYPH_VENDOR         = 26326;
uint32 WARLOCK_GLYPH_VENDOR      = 26331;
uint32 DRUID_GLYPH_VENDOR        = 26324;
...
public:
	...
	{
		player->ADD_GOSSIP_ITEM(3, "Teach me all my class spells, etc.", GOSSIP_SENDER_MAIN, 1);
