...
class Transmorgrification_NPC : public CreatureScript
{
public:
    Transmorgrification_NPC() : CreatureScript("Transmorgrification_NPC") { } // Also set in Player.cpp: if (creature->GetScriptName() == "NPC_TransmogDisplayVendor")
