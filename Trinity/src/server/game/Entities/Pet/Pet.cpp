...
void Creature::Regenerate(Powers power)
{
    ...
    switch (power)
    {
        ...
        case POWER_ENERGY:
        {
            // Energy ticks up by 1 point every one decisecond for death knight ghouls, Source: WoWWiki.
            addvalue = 1;
            break;
        }
        default:
...
bool Guardian::InitStatsForLevel(uint8 petlevel)
{
    ...
    switch (petType)
    {
        ...
        case HUNTER_PET:
        {
            ...
            SetBaseWeaponDamage(BASE_ATTACK, MINDAMAGE, float(petlevel - (petlevel / 3.5)));
            //damage range is then petlevel / 2
            SetBaseWeaponDamage(BASE_ATTACK, MAXDAMAGE, float(petlevel + (petlevel / 3.5)));
